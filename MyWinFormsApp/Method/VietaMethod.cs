...
public class VietaMethod : DiscriminantMethod
{
    ...
    public override void GreaterThanZero(Document document, DArg arg)
    {
        ...
        var formula = @"\begin{cases}x_1 + x_2 = \frac{" + -arg.B + "}{" + arg.A + @"}\\x_1 \cdot x_2 = \frac{" + arg.C + @"}{" + arg.A + @"}\end{cases}\begin{array}{|c} x_1="+x1+ @" \\  x_2="+x2+ @"\end{array}";
    ...
    public override void EqualToZero(Document document, DArg arg)
    {
        ...
        var formula = @"\begin{cases}x_1 + x_2 = \frac{" + -arg.B + "}{" + arg.A + @"}\\x_1 \cdot x_2 = \frac{" + arg.C + @"}{" + arg.A + @"}\end{cases}\begin{array}{|} \\ \\ \end{array}\begin{array} & x_1=x_2=" + x1 + @"\end{array}";
        var img1 = new iText.Layout.Element.Image(
                       ImageDataFactory.Create(
                           ImageHelper.ImageToBitmap(ImageHelper.GetImageFormula(formula))
                           , Color.White, false)
